function varargout = deltatodelta(varargin)
% DELTATODELTA MATLAB code for deltatodelta.fig
%      DELTATODELTA, by itself, creates a new DELTATODELTA or raises the existing
%      singleton*.
%
%      H = DELTATODELTA returns the handle to a new DELTATODELTA or the handle to
%      the existing singleton*.
%
%      DELTATODELTA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DELTATODELTA.M with the given input arguments.
%
%      DELTATODELTA('Property','Value',...) creates a new DELTATODELTA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before deltatodelta_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to deltatodelta_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help deltatodelta

% Last Modified by GUIDE v2.5 21-Feb-2022 03:11:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @deltatodelta_OpeningFcn, ...
                   'gui_OutputFcn',  @deltatodelta_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before deltatodelta is made visible.
function deltatodelta_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to deltatodelta (see VARARGIN)

% Choose default command line output for deltatodelta
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes deltatodelta wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = deltatodelta_OutputFcn(hObject, eventdata, handles) 
...
[a b c d e] = deltadeltaCon(vp1,vp2,vp3,zl1,zl2,zl3,ld1,ld2,ld3);
...
% --- Executes during object creation, after setting all properties.
function ILine1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ILine1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
