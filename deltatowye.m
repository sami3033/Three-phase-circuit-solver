function varargout = deltatowye(varargin)
% DELTATOWYE MATLAB code for deltatowye.fig
%      DELTATOWYE, by itself, creates a new DELTATOWYE or raises the existing
%      singleton*.
%
%      H = DELTATOWYE returns the handle to a new DELTATOWYE or the handle to
%      the existing singleton*.
%
%      DELTATOWYE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DELTATOWYE.M with the given input arguments.
%
%      DELTATOWYE('Property','Value',...) creates a new DELTATOWYE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before deltatowye_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to deltatowye_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help deltatowye

% Last Modified by GUIDE v2.5 21-Feb-2022 11:27:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @deltatowye_OpeningFcn, ...
                   'gui_OutputFcn',  @deltatowye_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before deltatowye is made visible.
function deltatowye_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to deltatowye (see VARARGIN)

% Choose default command line output for deltatowye
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes deltatowye wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = deltatowye_OutputFcn(hObject, eventdata, handles) 
...
[a b c d e] = deltawyeCon(vp1,vp2,vp3,zl1,zl2,zl3,ld1,ld2,ld3);
