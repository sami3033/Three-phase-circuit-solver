function varargout = wyetodelta(varargin)
% WYETODELTA MATLAB code for wyetodelta.fig
%      WYETODELTA, by itself, creates a new WYETODELTA or raises the existing
%      singleton*.
%
%      H = WYETODELTA returns the handle to a new WYETODELTA or the handle to
%      the existing singleton*.
%
%      WYETODELTA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WYETODELTA.M with the given input arguments.
%
%      WYETODELTA('Property','Value',...) creates a new WYETODELTA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wyetodelta_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wyetodelta_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wyetodelta

% Last Modified by GUIDE v2.5 21-Feb-2022 11:11:21

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wyetodelta_OpeningFcn, ...
                   'gui_OutputFcn',  @wyetodelta_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wyetodelta is made visible.
function wyetodelta_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wyetodelta (see VARARGIN)

% Choose default command line output for wyetodelta
...
% UIWAIT makes wyetodelta wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wyetodelta_OutputFcn(hObject, eventdata, handles) 
...
[a b c d e] = wyedeltaCon(vp1,vp2,vp3,zl1,zl2,zl3,ld1,ld2,ld3);
