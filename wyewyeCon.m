function [Line_Current Load_Current Load_Voltage Line_Voltage Power] = wyewyeCon(V_Phase1,V_Phase2,V_Phase3,Z_Line1,Z_Line2,Z_Line3,Load1,Load2,Load3)
    ...
    I_Line1 = Current_Matrix(1,1);
    I_Line2 = (Current_Matrix(2,1) - Current_Matrix(1,1));
    I_Line3 = -Current_Matrix(2,1);
